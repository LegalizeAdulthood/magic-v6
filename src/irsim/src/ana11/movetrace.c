...
private	void    DeleteTrace(), SelectTrace(), MoveTraces();
 ...
 */
private void MoveTraces( from, to )
  Trptr  from, to;
  {
    Trptr  tmp;
    BBox   rb;
