...
double nldl_rk4( alpha, beta, h )
  ...
  {   
    ...
    if( i == j )
      {   
	fprintf( stderr, "RK4 error: nldl: Didn't reach the peak\n" );
 ...
 */
nldl_vector( alpha, beta, h, v1, v2, k1, k2 )
...
double nldh_rk4( alpha, beta, h )
  ...
  {   
    ...
    if( i == j )
      {   
	fprintf( stderr, "RK4 error: nldh: Didn't reach the peak\n" );
	fprintf( stderr, "alpha = %f beta = %f h = %f\n", alpha, beta, h );
	exit( 1 );
    }
}
 ...
 */
nldh_vector( alpha, beta, h, v1, v2, k1, k2 )
  double alpha, beta, h, v1, v2, *k1, *k2;
  {   
    double  u1, u2;
 ...
 */
linear_spike( alpha, beta, delay, peak )
