 ...
 *     *********************************************************************
 *
 * rcsid $Header: calmaInt.h,v 6.0 90/08/28 18:03:53 mayo Exp $
 */
...
#endif	_MAGIC
#ifndef	_HASH
int err1 = Need_to_include_hash_header;
#endif	_HASH
#ifndef	_DATABASE
 ...
 */
#ifdef ibm032
#include <sys/types.h>     /* some of the word order routines are defined   */
...
/*
 * Macro to read a point from the input.
...
#define READPOINT(p) \
	{ \
	    READI4((p)->p_x); \
	    READI4((p)->p_y); \
	    (p)->p_x = (p)->p_x * calmaReadScale1 / calmaReadScale2; \
	    (p)->p_y = (p)->p_y * calmaReadScale1 / calmaReadScale2; \
	}
