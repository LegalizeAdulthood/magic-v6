...
#ifndef	lint
static char rcsid[] = "$Header: DBcell.c,v 6.0 90/08/28 18:09:27 mayo Exp $";
#endif	not lint
    ...
    struct searchArg * arg;		/* celluse, rect, plane */
{
    ...
    MALLOC(CellTileBody *, body, sizeof (CellTileBody));
    ...
    Tile *      newtp;
{
    ...
    {
	MALLOC(CellTileBody *, newctb, sizeof (CellTileBody));
...
ctbListMatch (tp1, tp2)
    Tile      * tp1, * tp2;
{
    register CellTileBody * ctp1, * ctp2;
