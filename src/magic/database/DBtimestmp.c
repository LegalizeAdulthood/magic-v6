...
#ifndef lint
static char rcsid[] = "$Header: DBtimestmp.c,v 6.0 90/08/28 18:10:27 mayo Exp $";
#endif  not lint
...
DBFixMismatch()
{
    ...
    TxPrintf(".\n");
    TxFlush();
    if (redisplay) WindAreaChanged((Window *) NULL, (Rect *) NULL);
}
					 ...
					 */
{
    ...
    MALLOC(Mismatch *, mm, sizeof (Mismatch));
