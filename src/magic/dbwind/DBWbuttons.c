 ...
 * can register themselves, and the current handler can be switched
...
#ifndef lint
static char rcsid[] = "$Header: DBWbuttons.c,v 6.0 90/08/28 18:11:17 mayo Exp $";
#endif  not lint
