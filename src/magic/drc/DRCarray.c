				 ...
				 */
{
	...
	errorArea.r_xtop = use->cu_bbox.r_xbot + xsize + TechHalo;
	errorArea.r_ybot = use->cu_bbox.r_ybot + ysep - TechHalo;
	errorArea.r_ytop = use->cu_bbox.r_ybot + ysize + TechHalo;
	...
	errorArea.r_xbot = use->cu_bbox.r_xtop - TechHalo;
	GeoClip(&errorArea, area);
	if (!GEO_RECTNULL(&errorArea))
	{
	    GEO_EXPAND(&errorArea, TechHalo, &yankArea);
	...
	errorArea.r_xbot = use->cu_bbox.r_xbot + xsep - TechHalo;
	errorArea.r_xtop = use->cu_bbox.r_xbot + xsize + TechHalo;
	...
	errorArea.r_ybot = use->cu_bbox.r_ytop - TechHalo;
	GeoClip(&errorArea, area);
	if (!GEO_RECTNULL(&errorArea))
	{
	    GEO_EXPAND(&errorArea, TechHalo, &yankArea);
