...
#ifndef lint
static char rcsid[] = "$Header: gaSimple.c,v 6.0 90/08/28 18:52:26 mayo Exp $";
#endif  not lint
...
extern gaMetalClear, gaPolyClear, gaContactClear;
...
gaStemSimpleInit(routeUse, term, pinPoint, pinSide, simple)
    ...
    register Point *pinPoint;		/* Crossing point to reach */
    int pinSide;			/* Direction of pin from term. */
    register SimpleStem *simple;	/* Fill this in */
{

    register SimpleWire *sMetal = &simple->ss_metalWire;
    register SimpleWire *sPoly = &simple->ss_polyWire;
    register Rect *cTerm = &simple->ss_cTerm;
    register Rect *cPin = &simple->ss_cPin;
    register Rect *termLoc = &term->nloc_rect;
