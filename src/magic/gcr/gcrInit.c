...
#ifndef lint
static char rcsid[] = "$Header: gcrInit.c,v 6.0 90/08/28 18:37:59 mayo Exp $";
#endif  not lint
...
Void
gcrSetEndDist(ch)
    register GCRChannel *ch;	/* The channel to be routed */
{
    ...
    register GCRChannel *ch;
{
    ...
    {
	/* New net */
	MALLOC(GCRNet *, net, sizeof (GCRNet));
	HashSetValue(hEntry, (char *) net);
	net->gcr_Id = (int) pin->gcr_pId;
