...
#ifndef lint
static char rcsid[] = "$Header: gcrUnsplit.c,v 6.0 90/08/28 18:38:10 mayo Exp $";
#endif  not lint
    ...
    int		  from, to, column;
{
    ...
    covered	= firstFlag & (GCRBLKM | GCRBLKP);
    sourceEnds=(firstFlag & GCRTE); 
