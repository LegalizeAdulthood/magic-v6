...
#ifndef	lint
static char rcsid[] = "$Header: grouteMult.c,v 6.1 90/08/28 19:15:55 mayo Exp $";
#endif	lint
...
glMultiSteiner(rootUse, net, routeProc, markProc, cdRoute, cdMark)
    ...
    Void (*markProc)();		/* Procedure to remember the route */
...
{
    register GlPoint *srcEntry, *dstEntry;
