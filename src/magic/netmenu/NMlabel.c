...
#ifndef lint
static char rcsid[] = "$Header: NMlabel.c,v 6.0 90/08/28 18:50:33 mayo Exp $";
#endif  not lint
...
NMChangeNum(window,cmd, nmButton, point)
    Window *window;		/* Window in which button was pushed. */
...
NMPutLabel(window, cmd, nmButton, point)
    Window *window;		/* Window where mouse button was pushed.
				 * (ignored) */
...
NMReOrientLabel(window, cmd, nmButton, point)
    Window *window;		/* Window that was buttoned. (ignored) */
