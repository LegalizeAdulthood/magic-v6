...
#ifndef lint
static char rcsid[]="$Header: plotGremln.c,v 6.0 90/08/28 18:51:47 mayo Exp $";
#endif  not lint
...
plotGremlinRect(rect, lineStyle)
    register Rect *rect;	/* Rectangle to be drawn, in root coords. */
					 ...
					 */
{
	...
	(void) DBTreeSrLabels(scx, &curMask, xMask, (TerminalPath *) NULL,
		plotGremlinLabel, (ClientData) NULL);
    }
