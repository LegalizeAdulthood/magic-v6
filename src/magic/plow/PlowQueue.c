...
#ifndef lint
static char rcsid[]="$Header: PlowQueue.c,v 6.0 90/08/28 18:53:06 mayo Exp $";
#endif  not lint
...
plowQueueAdd(eadd)
    register Edge *eadd;	/* Edge added to queue.  We assume that
