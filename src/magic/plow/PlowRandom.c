...
#ifndef lint
static char rcsid[]="$Header: PlowRandom.c,v 6.0 90/08/28 18:53:09 mayo Exp $";
#endif  not lint
    ...
    CellDef *def;
{
	...
	DBPutLabel(def, &def->cd_bbox, -1, "dummylabel", TT_SPACE);
...
plowGenRect(bbox, r)
    register Rect *bbox;	/* Bounding box of the cell being plowed */
    register Rect *r;		/* Fill in this rectangle */
{
    register int temp;
