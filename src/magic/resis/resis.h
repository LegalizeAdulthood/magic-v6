...
typedef struct resnode
{
     ...
     char		*rn_name;	/* Pointer to hash table name for */
					/* this node.			 */
...
typedef struct ressimnode
{
     ...
     Rect		rs_bbox;	/* location of bottom of leftmost */
					/* tile in the lowest numbered    */
					/* plane contained in the node .  */
     int		type;		/* Tile type of tile at location  */
...
/* The following turns on and off various options for REDS  */
...
{\
	...
	MALLOC(Breakpoint *,bp,sizeof(Breakpoint)); \
