...
#ifndef lint
static char rcsid[]="$Header: rtrChannel.c,v 6.0 90/08/28 18:55:41 mayo Exp $";
#endif  not lint
...
rtrChannelObstacleMark(tile, cxp)
    ...
    TreeContext *cxp;
{
    register short **mcol, *mrow, *mrowend, mask;
    register GCRChannel *ch = (GCRChannel *) cxp->tc_filter->tf_arg;
...
RtrChannelDensity(ch)
    GCRChannel *ch;
{
    register short *hdens, *vdens, *rptr;
    register int col, density;
    short *hdend, *vdend;
