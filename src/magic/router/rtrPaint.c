...
#ifndef lint
static char rcsid[]="$Header: rtrPaint.c,v 6.0 90/08/28 18:55:52 mayo Exp $";
#endif  not lint
...
rtrDoVia(ch, col, row)
    ...
    register int col;	/* The x coordinate of the location considered */
    register int row;	/* The y coordinate of the location considered */
{
